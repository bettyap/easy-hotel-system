...
namespace EasyHotelSystem.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public RoomsController(EasyHotelSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NumQuarto,DescQuarto,StatusQuarto,ValorDiaria,CodReserva")] Room room)
        {
        ...
        {
            return _context.Room.Any(e => e.NumQuarto == id);
        }
    }
}
