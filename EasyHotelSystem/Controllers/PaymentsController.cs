...
namespace EasyHotelSystem.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(EasyHotelSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CodPagamento,NumQuarto,TipoQuarto,NomeHos,QtdCriancas,QtdAdu,Valor,DataCheckin,DataCheckout,HrCheckin,HrCheckout,CpfFunc,CpfHos,Taxa,FormaPag")] Payment payment)
        {
        ...
        {
            return _context.Payment.Any(e => e.CodPagamento == id);
        }
    }
}
